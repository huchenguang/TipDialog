package com.hcg.tipdialoglibrary.widget;
...
import com.hcg.tipdialoglibrary.R;
import com.hcg.tipdialoglibrary.utils.DimenUtils;
...
public class TipLoadDialog {
     ...
     * 默认提示信息图标
     */
    public int INFO_ICON = R.mipmap.qmui_icon_notify_info;
     ...
     * 设置是否屏蔽返回键
     */
    private boolean backDismissEnable = true;

    public void setBackDismissEnable(boolean enable) {
        this.backDismissEnable = enable;
    }
    ...
    class MyDialog extends Dialog {
        ...
        public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_BACK && backDismissEnable) {
